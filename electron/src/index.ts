...
import * as AsyncDB from './main/data/AsyncDB';
import Database from './main/data/Database';
...
const flacFilename = app.isPackaged ? path.join(os.homedir(), ".flac.db") : "flac.db";

const database = ((): (() => Promise<Database>) => {
  let data: Database | undefined;
